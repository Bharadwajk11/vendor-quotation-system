...
-   **Technical Implementations**: Standalone Angular components, service-based state management, Django REST Framework ViewSets, Django ORM. Responsive design uses Angular CDK BreakpointObserver to detect screen sizes (Handset, TabletPortrait, TabletLandscape) and dynamically switch between mobile card view and desktop table view.
